...
export default function Carousel() {
  ...
  const services = [
    {
      id: 1,
      image: '/assets/icons/instant-loan.png',
      name: 'Instant Loan',
    ...
    {
      id: 2,
      image: '/assets/icons/personal-loan.png',
      name: 'Instant Loan',
    ...
    {
      id: 3,
      image: '/assets/icons/business-loan.png',
      name: 'Instant Loan',
    ...
    {
      id: 4,
      image: '/assets/icons/professional-loans.png',
      name: 'Instant Loan',
    ...
    {
      id: 5,
      image: '/assets/icons/secured-loans.png',
      name: 'Instant Loan',
    ...
    {
      id: 6,
      image: '/assets/icons/balance-transfer.png',
      name: 'Instant Loan',
