        ...
        <section className="main-content">
          <div className="content-wrapper">
            <div className="cibil-page-container">
              ...
              <section className="cibil-cta-section cibil-form-section">
                ...
                <div className="cibil-form-wrapper">
                  <form className="contact-form cibil-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      <label className="form-label">{t('cibil.formNameLabel') || 'Enter name as per Pan Card'}</label>
                    ...
                    <div className="form-group">
                      <label className="form-label">{t('cibil.formPanLabel') || 'PAN Number'}</label>
                      <div className="form-input-wrapper">
                        <svg className="form-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="form-group">
                      <label className="form-label">{t('cibil.formDobLabel') || 'Date of Birth'}</label>
                      <div className="form-input-wrapper">
                        <svg className="form-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="form-row">
                      <div className="form-group">
                        <label className="form-label">{t('cibil.formMobileLabel') || 'Mobile Number'}</label>
                        <div className="form-input-wrapper">
                          <svg className="form-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="form-group">
                        <label className="form-label">{t('cibil.formEmailLabel') || 'Email ID'}</label>
                        <div className="form-input-wrapper">
                          <svg className="form-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="form-row">
                      <div className="form-group">
                        <label className="form-label">{t('cibil.formCityLabel') || 'City'}</label>
                        <div className="form-input-wrapper">
                          <svg className="form-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="form-group">
                        <label className="form-label">{t('cibil.formPincodeLabel') || 'Pincode'}</label>
                        <div className="form-input-wrapper">
                          <svg className="form-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
